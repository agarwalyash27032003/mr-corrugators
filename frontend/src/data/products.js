export const productData = [
  ...
  // STRETCH FILMS
  {
    ...
    name: "Stretch Films",
    description:
      "High-quality stretch films used for pallet wrapping and securing goods during storage and transportation.",
    features: [
      'Available in Sizes 3" to 24"',
      "High Elasticity",
      "Tear Resistant",
  ...
  // BUBBLE WRAP
  {
    ...
    description:
      "Protective packaging material with air-filled bubbles designed to cushion fragile items during shipping.",
    features: [
      "Standard Size: 1m x 100m",
      "Lightweight (3.5–4 kg approx.)",
      "Shock Absorption",
