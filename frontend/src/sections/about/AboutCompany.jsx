          ...
          <div className="lg:w-1/2 lg:pt-16">
            <div className="space-y-8">
              <p className="text-lg md:text-xl text-slate-900 font-bold leading-snug">
                MR Corrugators is not just a packaging manufacturer—it is a solution-driven business built to support growing companies with reliable and efficient packaging.
              </p>
              <p className="text-lg md:text-xl text-slate-900 font-bold leading-snug">
              ...
              <p className="text-lg md:text-xl text-slate-900 font-bold leading-snug">
                We are also committed to responsible packaging practices by focusing on efficient material usage, reducing unnecessary waste, and promoting sustainable packaging solutions that minimize environmental impact without compromising performance or quality.
              </p>
              <p className="text-lg md:text-xl text-slate-900 font-bold leading-snug">
